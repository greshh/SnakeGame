// 159261 Assignment 1 - Greshka Lao 22012395

/* EXTRA FEATURES */
// - enabled multiplayer.
// - in multiplayer, players can lose when their head hits the other's body.
// - menu for when game is over/completed and who wins, which can enable replay.
// - "help" function that shows instructions.
...
public class LaoG_22012395_Assignment1 extends GameEngine 
{
    public static void main(String args[]) 
    {
        createGame(new LaoG_22012395_Assignment1(), 10);
    }
